...
class CrossEntropy(nn.Module):
    def __init__(self, para_dict=None):
        ...
        self.drw = self.para_dict['two_stage_drw']
        self.drw_start_epoch = self.para_dict['two_stage_start_epoch']
...
class CrossEntropyLabelSmooth(CrossEntropy):
    ...
    def __init__(self, para_dict=None):
        ...
        self.epsilon = self.para_dict['ce_label_smooth_epsilon']  # hyper-parameter in label smooth
...
class CrossEntropyLabelAwareSmooth(CrossEntropy):
    ...
    def __init__(self, para_dict=None):
        ...
        smooth_head = self.para_dict['ce_label_aware_smooth_head']
        smooth_tail = self.para_dict['ce_label_aware_smooth_tail']
        shape = self.para_dict['ce_label_aware_smooth_shape']
...
class FocalLoss(CrossEntropy):
    ...
    def __init__(self, para_dict=None):
        ...
        self.gamma = self.para_dict['focal_loss_gamma']  # hyper-parameter
...
class ClassBalanceCE(CrossEntropy):
    ...
    def __init__(self, para_dict=None):
        ...
        self.beta = self.para_dict['class_balance_ce_beta']
...
class ClassBalanceFocal(CrossEntropy):
    ...
    def __init__(self, para_dict=None):
        ...
        self.beta = self.para_dict['class_balance_focal_beta']
        self.gamma = self.para_dict['class_balance_focal_gamma']
        self.class_balanced_weight = np.array([(1-self.beta)/(1 - self.beta ** N) for N in self.num_class_list])
        self.class_balanced_weight = torch.FloatTensor(self.class_balanced_weight / np.sum(self.class_balanced_weight) * self.num_classes).to(self.device)
        self.sigmoid = nn.Sigmoid()
...
class CostSensitiveCE(CrossEntropy):
    ...
    def __init__(self, para_dict=None):
        ...
        gamma = self.para_dict['cost_sensitive_ce_gamma']
...
class LDAMLoss(CrossEntropy):
    ...
    def __init__(self, para_dict=None):
        ...
        s = self.para_dict['LDAM_scale']
        max_m = self.para_dict['LDAM_max_margin']
        self.max_m = max_m
...
class SEQL(CrossEntropy):
    ...
    def __init__(self, para_dict=None):
        ...
        self.t_lambda = ((num_class_list/num_class_list.sum()) < self.para_dict['SEQL_lambda']).to(self.device)
        self.gamma = self.para_dict['SEQL_gamma']
...
class CDT(CrossEntropy):
    ...
    def __init__(self, para_dict=None):
        ...
        self.gamma = self.para_dict['CDT_gamma']
